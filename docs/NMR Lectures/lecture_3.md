...
**Contamination** means: some \(\rho^{(m)}(t)\) are generated by *unintended* pathways, but they still contribute to the same transverse observables \(I_x, I_y\) at the echo times. They can therefore distort echo amplitudes, phases, and decays.
